...
define('GUSER', 'rayzin147@gmail.com'); // GMail username to access SMTP mail server
define('GPWD', 'oujy qxfz tsjg dfkh'); // GMail app password to access SMTP mail server
